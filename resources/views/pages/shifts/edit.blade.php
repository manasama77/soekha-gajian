<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            <div class="">
                <a href="{{ route('setup.shifts.index') }}"
    ...
    <div class="py-12">
        <div class="max-w-7xl sm:px-6 lg:px-8 mx-auto">
            <div
                ...
                <form action="{{ route('setup.shifts.update', $shift) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        <label for="name" class="dark:text-white block mb-2 text-sm font-medium text-gray-900">Nama
                            Shift</label>
                        <input type="text" name="name" id="name" placeholder="Masukkan Nama Shift"
                    ...
                    <div class="mb-4">
                        <label for="start_time" class="dark:text-white block mb-2 text-sm font-medium text-gray-900">
                            Start Time
                        </label>
                        <div class="relative">
                            ...
                            <input type="time" id="start_time" name="start_time" value="{{ $shift->start_time }}"
                    ...
                    <div class="mb-4">
                        <label for="end_time" class="dark:text-white block mb-2 text-sm font-medium text-gray-900">
                            End Time
                        </label>
                        <div class="relative">
                            <div class="absolute inset-y-0 end-0 top-0 flex items-center pe-3.5 pointer-events-none">
                            ...
                            <input type="time" id="end_time" name="end_time" value="{{ $shift->end_time }}"
                                class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                        </div>
                        @error('end_time')
                    ...
                    <div class="mb-4">
                        <label for="is_perbantuan_shift"
                            class="dark:text-white block mb-2 text-sm font-medium text-gray-900">
                            Perbantuan Shift?
                        </label>
                        <select id="is_perbantuan_shift" name="is_perbantuan_shift"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required>
                            <option @selected($shift->is_perbantuan_shift == 0) value="0">Tidak</option>
                            <option @selected($shift->is_perbantuan_shift == 1) value="1">Ya</option>
                        </select>
                        @error('is_perbantuan_shift')
                            <p class="text-xs italic text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
