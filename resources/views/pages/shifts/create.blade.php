    ...
    <div class="py-12">
        <div class="max-w-7xl sm:px-6 lg:px-8 mx-auto">
            <div
                ...
                <form action="{{ route('setup.shifts.store') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="is_perbantuan_shift" name="is_perbantuan_shift"
                            ...
                            required>
                            <option @selected(old('is_perbantuan_shift') == '0') value="0">Tidak</option>
                            <option @selected(old('is_perbantuan_shift') == '1') value="1">Ya</option>
                        </select>
